...
namespace FormCharts3 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string name_products, int price) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow FindByarticle(int article) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int article {
                get {
                    return ((int)(this[this.tableTable.articleColumn]));
                }
                set {
                    this[this.tableTable.articleColumn] = value;
                }
            }
            ...
            public string name_products {
                get {
                    return ((string)(this[this.tableTable.name_productsColumn]));
                }
                set {
                    this[this.tableTable.name_productsColumn] = value;
                }
            }
...
namespace FormCharts3.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([article] = @Original_article) AND ([name_produ" +
                "cts] = @Original_name_products) AND ([price] = @Original_price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([name_products], [price]) VALUES (@name_products, @pri" +
                "ce);\r\nSELECT article, name_products, price FROM [Table] WHERE (article = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [name_products] = @name_products, [price] = @price WHERE (([article] = @Original_article) AND ([name_products] = @Original_name_products) AND ([price] = @Original_price));
SELECT article, name_products, price FROM [Table] WHERE (article = @article)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT article, name_products, price FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_article, string Original_name_products, int Original_price) {
        ...
        public virtual int Insert(string name_products, int price) {
        ...
        public virtual int Update(string name_products, int price, int Original_article, string Original_name_products, int Original_price, int article) {
            if ((name_products == null)) {
                throw new global::System.ArgumentNullException("name_products");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name_products, int price, int Original_article, string Original_name_products, int Original_price) {
